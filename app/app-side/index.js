    ...
    .then((data) => {
      try {
        ...
        const transformedInfo = {
          bg: {
            val: typeof data.bgnow.sgvs[0].scaled === 'number' ? data.bgnow.sgvs[0].scaled.toString() : data.bgnow.sgvs[0].scaled,            delta: data.delta.scaled,
          ...
          status: {
            isMgdl: isMgdl = data.bgnow.sgvs[0].scaled && data.bgnow.sgvs[0].mgdl ? data.bgnow.sgvs[0].scaled === data.bgnow.sgvs[0].mgdl : null,
          },
          settings: {
